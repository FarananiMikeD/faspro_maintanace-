exports.doneRegMSG = (firstName, lastName) => `
...
<body>
    <div class="container">
        <div class="header">
        <h1 style="color: white">${process.env.DOMAIN_LABEL}</h1>
        </div>
        <div class="content">
            ...
            <div class="img__container">
                ...
                <h6 style="margin-top: 0; margin-bottom: 20px; font-size: 24px; font-weight: bold; color: #26a958;">
                    Hi ${process.env.EMAIL_SENDER_NAME} 
                </h6>
                ...
                <p style="margin-top: 0; margin-bottom: 20px; font-size: 16px; line-height: 1.5;">
                    I have completed my registration form kindly review it and give me a feedback
                </p>
            ...
            <a class="nice-button" style="margin-top: 0; margin-bottom: 20px; font-size: 18px; font-weight: bold; color: #26a958;" href=${process.env.FRONT_END_URL}> Click here </a>
            </div>
        </div>
