exports.alertRegistrationMSG = (firstName, lastName, email, phoneNumber) => `
        ...
        <div class="content">
            ...
            <img src="https://faspro24.com/wp-content/uploads/2023/05/faspro24_comfirm-your-email_illustration1.png"
                ...
                <h6 style="margin-top: 0; margin-bottom: 20px; font-size: 24px; font-weight: bold; color: #26a958;">
                    Hey👋 ${process.env.DOMAIN_LABEL}, 
                </h6>

                <p style="margin-top: 0; margin-bottom: 20px; font-size: 16px; line-height: 1.5;">
                Attention: A user named ${firstName} ${lastName} is attempting to register without providing an invoice number. 
                </p>

                <p style="margin-top: 0; margin-bottom: 20px; font-size: 16px; line-height: 1.5;">
               We kindly request that you verify the invoice information provided by this user with the email address: ${email} and phone number: ${phoneNumber}. 
                </p>

                <p style="margin-top: 0; margin-bottom: 20px; font-size: 16px; line-height: 1.5;">
               This will ensure that the registration process proceeds smoothly and without any issues. Please take appropriate action to ensure that the user has a valid invoice before proceeding with their registration. Thank you for your cooperation.
                </p>


                <p style="margin-top: 0; margin-bottom: 20px; font-size: 16px; line-height: 1.5; text-align: center">
              Click on the button bellow to login into the system and took actions as soon as possible  👇
              </p>
            ...
            href=${process.env.FRONT_END_URL}> Click to login
        </a>
