exports.leaInvoiceMSG = (LeadDet, leadInvoiceNumber, invoiceSettingId, savedLeadInvoice, createdDate, dueDate, invoiceStatus) => `
...
<body>
    <div class="container">
        ...
        <h4 style="text-align:center">Address: ${invoiceSettingId?.address} | Phone number: ${invoiceSettingId?.phoneNumber} | Email:
        ${invoiceSettingId?.email}
        </h4>
        ...
        <div class="invoice-details">
            <div class="header__details">
                <div>Invoice Number: <b> ${leadInvoiceNumber} </b></div>
                <div>Created date: ${createdDate} </div>
                <div>Due date: ${dueDate} </div>
                <div>Invoice Status: <b> ${invoiceStatus}   </b></div>
            </div>
            <div class="billed__to__details">
                <b>Billed To:</b>
                <div>Company name:  ${LeadDet.companyName}</div>
                <div>Full name: ${LeadDet.firstName} ${LeadDet.lastName} </div>
                <div>Email: ${LeadDet.email}</div>
                <div>Contact:  ${LeadDet.phoneNumber}</div>
            </div>
        ...
        (`<tr>
            ...
            <td class="item-qty"> ${savedLeadInvoice.facilityPrice} </td>
                    ...
                    ${savedLeadInvoice.maintenance !== "maintenance" ? (`<tr>
                    <td> - </td>
                    <td>  -  </td>
                    <td class="item-qty"> - </td>
                    <td class="item-qty"> - </td>
    ...
    ${savedLeadInvoice.security !== "security" ? (`<tr>
    <td> - </td>
    <td>  -  </td>
    <td class="item-qty"> - </td>
    <td class="item-qty"> - </td>
...
<td class="item-qty"> &#8615;${savedLeadInvoice.securityPrice} </td>
    ...
    ${savedLeadInvoice.assets !== "assets" ? (`<tr>
    <td> - </td>
    <td>  -  </td>
    <td class="item-qty"> - </td>
    <td class="item-qty"> - </td>
...
<td class="item-qty">${savedLeadInvoice.assetsPrice} </td>
    ...
    ${savedLeadInvoice.fileManagement !== "fileManagement" ? (`<tr>
    <td> - </td>
    <td>  -  </td>
    <td class="item-qty"> - </td>
    <td class="item-qty"> - </td>
...
<td class="item-qty">${savedLeadInvoice.fileManagementPrice}</td>
    ...
    ${savedLeadInvoice.bookings !== "booking" ? (`<tr>
    <td> - </td>
    <td>  -  </td>
    <td class="item-qty"> - </td>
    <td class="item-qty"> - </td>
...
<td class="item-qty"> ${savedLeadInvoice.bookingsPrice} </td>
        ...
        <div class="bank-details">
            <h4>Bank Details</h4>
            <ul>
            <li>Bank Name:${invoiceSettingId.bankName} </li>
            <li>Account Name: ${invoiceSettingId.accountName} </li>
            <li>Branch Name: ${invoiceSettingId.branchName} </li>
                <li>Account Number:  ${invoiceSettingId.accountNumber}</li>
            </ul>
        </div>
