...
exports.InviteTeamTemplate = (userDet, passwordGenerator) => `
        ...
        <div class="content">
            <div style="margin-bottom: 20px;">
                ...
                <p style="margin-top: 0; margin-bottom: 20px; font-size: 16px; font-weight: bold; color: #26a958; text-align:center">
                    Dear ${userDet.firstName} ${userDet.lastName}
                </p>

                <p style="margin-top: 0; margin-bottom: 20px; font-size: 16px; font-weight: bold; color: #26a958;">
                You have been added to ${process.env.FRONT_END_URL}
                </p>
                ...
                <p style="margin-top: 0; margin-bottom: 20px; font-size: 16px; font-weight: bold; color: #26a958;">
               <b>Email : </b> ${userDet.email}
                </p>

                <p style="margin-top: 0; margin-bottom: 20px; font-size: 16px; font-weight: bold; color: #26a958;">
                <b>Password : </b> ${passwordGenerator}
                </p>
