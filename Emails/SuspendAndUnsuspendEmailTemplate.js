...
exports.suspendAndUnsuspendTemplate = (data, displayMessage) => `
<!DOCTYPE html>
<html>
        ...
        <div class="content">
            <div style="margin-bottom: 20px;">
                ...
                <p style="margin-top: 0; margin-bottom: 20px; font-size: 16px; font-weight: bold; color: #26a958; text-align:center">
                    Dear ${data.firstName} ${data.firstName}
                </p>

                <p class="suspend__container" style="margin-top: 0; margin-bottom: 20px; font-size: 16px; font-weight: bold;">
            You have been ${displayMessage}  from accessing
                </p>
