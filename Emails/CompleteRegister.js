exports.completeRegMSG = (email, id, invoiceId, firstName, lastName, status) => `
        ...
        <div class="content">
            ...
            <img src="https://faspro24.com/wp-content/uploads/2023/05/faspro24_comfirm-your-email_illustration1.png"
                ...
                <p style="margin-top: 0; margin-bottom: 20px; font-size: 16px; line-height: 1.5;">
                    We are writing to inform you that a new lead has been submitted on your website. The details of the
                    lead are as follows: Please log in to your website to view and manage the lead.
                </p>
              

                <h5 style="margin-top: 0; margin-bottom: 20px; font-size: 24px; font-weight: bold; color: #26a958;">
                Click on the link bellow to complete your registration 👇
            </h5>

            <a class="nice-button" style="margin-top: 0; margin-bottom: 20px; font-size: 18px; font-weight: bold; color: #26a958;" href=${process.env.FRONT_END_URL}property-owner/${status}/${id}/${invoiceId}> Click here 
            </a>
