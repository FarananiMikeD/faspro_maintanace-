exports.subscriptionPackageMSG = (firstName, lastName, duration) => `
    ...
    <img src="https://faspro24.com/wp-content/uploads/2023/05/faspro24_logo_white1.png" alt="">
        ...
        <div class="content">
            ...
            <img src="https://faspro24.com/wp-content/uploads/2023/05/faspro24_comfirm-your-email_illustration1.png"
                ...
                We hope this message finds you well. We wanted to reach out and express our sincerest gratitude for choosing ${process.env.DOMAIN_LABEL}. We appreciate your trust in us and are committed to delivering the best experience possible.
                </p>

                <p style="margin-top: 0; margin-bottom: 20px; font-size: 16px; line-height: 1.5;">
                We are happy to inform you that your registration has been successfully completed, and your license for ${process.env.DOMAIN_LABEL} is now available. Your license is valid for ${duration}, and you can now start exploring all the great features Faspro24 has to offer.
                </p>

                <p style="margin-top: 0; margin-bottom: 20px; font-size: 16px; line-height: 1.5;">
              To get started, simply click here  <a style="margin-top: 0; margin-bottom: 20px; font-size: 24px; font-weight: bold; color: #26a958;" href=${process.env.FRONT_END_URL}> ${process.env.FRONT_END_URL} </a>. 
              
              If you have any questions or concerns, please don't hesitate to contact our customer support team, and we will be more than happy to assist you.
                </p>
